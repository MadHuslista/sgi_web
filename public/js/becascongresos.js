...
$(document).ready(function(){
	...
	$("#actualizarrango").on('click',function(){
			...
			$.redirect("../acreditacion/becas-congresos",{ inicio: $('#fechainicio').val(), termino: $('#fechatermino').val()}, 'GET');
	});
	...
	for (j=inicio; j<=termino;j++){
		...
		$.ajax({
				method: "GET",
				dataType: "json",
				url: "../api/get_montos_becas_congresos",
		})
		.done(function( msg ) {
			console.log(msg);
			console.log(i);
