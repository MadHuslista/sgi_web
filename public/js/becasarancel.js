...
$(document).ready(function(){
	...
	$("#actualizarrango").on('click',function(){
			...
			$.redirect("../acreditacion/becas-arancel",{ inicio: $('#fechainicio').val(), termino: $('#fechatermino').val()}, 'GET');
	});
	...
	for (j=inicio; j<=termino;j++){
		...
		$.ajax({
				method: "GET",
				dataType: "json",
				url: "../api/get_montos_becas_arancel",
		})
		.done(function( msg ) {
			console.log(msg);
			console.log(i);
			...
			var ctx = document.getElementById("canvas2").getContext("2d");
				...
				responsive: true,
				bezierCurve : false,
				yAxisMinimumInterval : 200000000,
				legend : true,
				datasetFill : false,
				thousandSeparator : ".",
				savePng : true,
